...
import com.cqjtu.cssl.utils.AjaxJson;
...
public class TestController {
  ...
  public AjaxJson session2() {
    ...
    System.out.println(
        "自定义 session的id为：" + SaSessionCustomUtil.getSessionById("1895544896").getId());
    System.out.println(
        "测试取值name：" + SaSessionCustomUtil.getSessionById("1895544896").getAttribute("name"));
