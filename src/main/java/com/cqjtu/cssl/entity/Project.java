...
public class Project {
    ...
    public Project(int proId, String labCenName, String expCname, String expEqname, int eqNum, String expMajor, String sSort, int expTime, String book, String softWare, String tId, String cName, String conName, int conNum) {
        this.proId = proId;
