...
(
    ...
    `tid`         char(12) CHARACTER SET utf8mb4    NULL     DEFAULT NULL COMMENT '教师编号',
    `course_id`   int(0)                            NULL     DEFAULT NULL COMMENT '课程编号',
    `lab_remark`  varchar(8) CHARACTER SET utf8mb4  NOT NULL DEFAULT '' COMMENT '实验室备注',
    `exp_proname` varchar(32) CHARACTER SET utf8mb4 NULL     DEFAULT NULL COMMENT '实验名称',
    `campus`      char(8) CHARACTER SET utf8mb4     NULL     DEFAULT NULL COMMENT '校区',
  ...
  AUTO_INCREMENT = 19
  CHARACTER SET = utf8mb4 COMMENT = '实验时间安排'
  ROW_FORMAT = Dynamic;
...
(
  ...
  CHARACTER SET = utf8mb4 COMMENT = '排课班级'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `class_name`  varchar(16) CHARACTER SET utf8mb4 NOT NULL,
...
(
    ...
    `course_name`    varchar(32) CHARACTER SET utf8mb4 NOT NULL,
    `course_college` varchar(32) CHARACTER SET utf8mb4 NOT NULL,
    `course_type`    varchar(8) CHARACTER SET utf8mb4  NULL DEFAULT NULL,
...
(
    ...
    `type_name` varchar(12) CHARACTER SET utf8  NOT NULL,
...
(
    ...
    `exp_cname`  varchar(32) CHARACTER SET utf8mb4  NOT NULL COMMENT '实验课程名',
    `exp_eqname` varchar(16) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '实验设备名',
    `eqnum`      int(0)                             NULL DEFAULT NULL COMMENT '设备数量',
    `exp_time`   int(0)                             NOT NULL COMMENT '实验总学时',
    `book`       varchar(128) CHARACTER SET utf8mb4 NULL DEFAULT NULL COMMENT '实验教材',
    `software`   varchar(32) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '实验所用软件',
    `exp_tid`    char(12) CHARACTER SET utf8mb4     NOT NULL COMMENT '授课教师编号',
    `lab_status` varchar(12) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '申请实验室状态',
    `con_name`   varchar(16) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '消耗材料名称',
    `con_num`    int(0)                             NOT NULL COMMENT '消耗材料数量',
    `course_id`  int(0)                             NOT NULL COMMENT '课程编号',
    `term`       varchar(16) CHARACTER SET utf8mb4  NOT NULL COMMENT '学期',
  ...
  AUTO_INCREMENT = 31
  CHARACTER SET = utf8mb4 COMMENT = '项目(实验卡片)'
  ROW_FORMAT = Dynamic;
...
(
    `lab_id`     varchar(16) CHARACTER SET utf8mb4 NOT NULL,
    `tid`        char(12) CHARACTER SET utf8mb4    NULL DEFAULT NULL,
    `type_id`    int(0)                            NULL DEFAULT NULL,
    `lab_name`   varchar(64) CHARACTER SET utf8mb4 NOT NULL,
    `lab_campus` char(4) CHARACTER SET utf8mb4     NOT NULL,
...
(
    ...
    `type_name` varchar(16) CHARACTER SET utf8mb4 NOT NULL,
...
(
    `major_id`   int(0)                            NOT NULL,
    `major_name` varchar(32) CHARACTER SET utf8mb4 NOT NULL,
    `college`    varchar(32) CHARACTER SET utf8mb4 NOT NULL,
...
(
    ...
    `notice_head`    varchar(64) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '通知标题',
    `notice_content` text CHARACTER SET utf8        NULL COMMENT '通知正文',
  ...
  AUTO_INCREMENT = 47
  CHARACTER SET = utf8 COMMENT = '通知信息表，通知由管理员发布。'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `file_name` varchar(64) CHARACTER SET utf8  NULL DEFAULT NULL COMMENT '通知文件名',
    ...
    `file_path` varchar(256) CHARACTER SET utf8 NULL DEFAULT NULL COMMENT '通知文件路径',
    PRIMARY KEY (`file_id`) USING BTREE
) ENGINE = InnoDB
  AUTO_INCREMENT = 20
  CHARACTER SET = utf8 COMMENT = '通知文件'
  ROW_FORMAT = Dynamic;
...
(
    ...
    `iname`  varchar(32) CHARACTER SET utf8mb4  NOT NULL,
    `itype`  varchar(8) CHARACTER SET utf8mb4   NOT NULL,
    `itime`  int(0)                             NOT NULL,
    `num`    int(0)                             NOT NULL,
    `intend` varchar(256) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `teach`
(
    `tid`       char(12) CHARACTER SET utf8mb4 NOT NULL,
    `course_id` int(0)                         NOT NULL,
...
(
    `tid`       char(12) CHARACTER SET utf8mb4    NOT NULL,
    `tname`     varchar(16) CHARACTER SET utf8mb4 NOT NULL,
    `tphone`    varchar(16) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
    `tqq`       varchar(16) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
    `temail`    varchar(32) CHARACTER SET utf8mb4 NULL DEFAULT NULL,
    `tpassword` varchar(16) CHARACTER SET utf8mb4 NOT NULL,
...
(
    ...
    `tid`     char(12) CHARACTER SET utf8mb4     NOT NULL,
    `mtitle`  varchar(36) CHARACTER SET utf8mb4  NOT NULL,
    `mresult` tinyint(0)                         NOT NULL,
    `mtext`   varchar(255) CHARACTER SET utf8mb4 NOT NULL,
