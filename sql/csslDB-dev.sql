...
-- ----------------------------
BEGIN;
INSERT INTO `arrange` VALUES (1, 'B01406', 1, '256740953460', 17015054, '17级3、4班', '无', '实验', '双福校区');
INSERT INTO `arrange` VALUES (3, '60201', 3, '123', 14211829, '计算机1班-计算机2班', '无', 'python语言', '南岸校区');
INSERT INTO `arrange` VALUES (4, 'B01406', 13, '123', 14210187, '计算机3班-计算机4班', '无', '上机', '双福校区');
INSERT INTO `arrange` VALUES (5, '60201', 18, '123', 14210669, '曙光班', '无', '汇编上机', '南岸校区');
INSERT INTO `arrange` VALUES (7, '60201', 3, '123', 14211829, '计算机1班', '无', 'python语言', '双福校区');
INSERT INTO `arrange` VALUES (8, '60201', 22, '123', 14211374, '计算机1班', '123', '移动app开发', '双福校区');
INSERT INTO `arrange` VALUES (9, '60201', 23, '123', 17015054, '计算机1班', '123', '上机实验', '双福校区');
INSERT INTO `arrange` VALUES (10, '60201', 24, '123', 17015184, '计算机1班', '123', '大数据概论实验', '双福校区');
INSERT INTO `arrange` VALUES (11, 'B01406', 25, '344847034079', 14210669, '计算机2班', '无', '实验课程名', '双福校区');
INSERT INTO `arrange` VALUES (12, 'B01406', 26, '344847034079', 14211346, '计算机2班', '无', '实验课程名', '双福校区');
INSERT INTO `arrange` VALUES (13, 'B01406', 27, '344847034079', 14211374, '计算机2班', '无', '实验课程名', '双福校区');
INSERT INTO `arrange` VALUES (14, 'B01406', 28, '344847034079', 14211829, '计算机2班', '无', '实验课程名', '双福校区');
INSERT INTO `arrange` VALUES (15, 'B01406', 29, '344847034079', 14212048, '计算机4班', '无', '实验课程名', '双福校区');
COMMIT;
...
INSERT INTO `arrange_period` VALUES (8, 1, 1, 1);
INSERT INTO `arrange_period` VALUES (9, 1, 1, 1);
INSERT INTO `arrange_period` VALUES (10, 1, 1, 1);
INSERT INTO `arrange_period` VALUES (11, 2, 4, 1);
INSERT INTO `arrange_period` VALUES (12, 2, 4, 4);
INSERT INTO `arrange_period` VALUES (13, 3, 4, 4);
INSERT INTO `arrange_period` VALUES (14, 3, 4, 5);
INSERT INTO `arrange_period` VALUES (15, 3, 6, 3);
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `exp_project` VALUES (1, '信息技术实践教学中心', 'java程序设计EB', '计算机', 40, '计算机科学与技术', '本科生', 32, '《Java语言程序设计》，辛运帏，饶一梅，人民邮电出版社，2009  ', 'eclipse，SQL Server, jdk', '256740953460', 'UNCHECK', 'java程序设计', '无', 2, 18210177, '2019/2020(2)');
INSERT INTO `exp_project` VALUES (3, '信息技术实践教学中心', 'python语言', '计算机', 40, '计算机科学与技术', '本科生', 45, '《数据预处理》', 'python', '123', 'UNCHECK', 'python', '无', 2, 14211829, '2019/2020(2)');
INSERT INTO `exp_project` VALUES (13, '信息技术实践教学中心', '上机', '设备', 1, '计算机科学与技术', '本科生', 40, '教材', '软件', '123', 'AUDITING', '操作系统原理A', '材料', 1, 14210187, '2019/2020(2)');
...
INSERT INTO `exp_project` VALUES (28, '信息技术实践教学中心', '实验课程名', '计算机', 0, '计算机科学与技术', '本科生', 40, '实验教材', '实验所用软件', '344847034079', 'AUDITING', '程序设计方法学', '无', 0, 14211829, '2019/2020(2)');
INSERT INTO `exp_project` VALUES (29, '信息技术实践教学中心', '实验课程名', '计算机', 0, '计算机科学与技术', '本科生', 40, '实验教材', '实验所用软件', '344847034079', 'AUDITING', '电子技术课外实践', '无', 0, 14212048, '2019/2020(2)');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `project_item` VALUES (1, 'XX11058-001', 1, '实验1', '验证', 2, 1, '熟悉JDK的安装和配置；熟悉Java IDE开发环境的安装；学习利用JDK和IDE开发工具编写简单的Java程序，熟悉Java程序的编写、编译和运行过程。');
INSERT INTO `project_item` VALUES (2, 'XX11058-002', 1, '实验2', '验证', 2, 1, '理解面向过程和面向对象；学会查阅JDK API文档；在类的方法中熟练使用三种基本控制结构');
INSERT INTO `project_item` VALUES (3, 'XX11058-003', 1, '实验3', '验证', 2, 1, '熟悉Java数组的定义、初始化和使用；掌握类的定义、创建对象；掌握方法的定义、重载；理解成员变量和局部变量。');
INSERT INTO `project_item` VALUES (4, 'XX11058-004', 1, '实验4', '验证', 4, 1, '熟练掌握构造器的定义和重载；熟练掌握类的继承；熟练使用访问控制符实现所需的封装要求；熟练掌握多态。');
INSERT INTO `project_item` VALUES (5, 'XX11058-005', 1, '实验5', '综合', 4, 1, '理解抽象的内涵，掌握抽象方法和抽象类的定义和使用；理解接口的内涵，掌握接口的定义和使用；掌握Java类库中基本类的使用。');
INSERT INTO `project_item` VALUES (6, 'XX11058-006', 3, '实验4', '验证', 4, 1, '熟练掌握构造器的定义和重载；熟练掌握类的继承；熟练使用访问控制符实现所需的封装要求；熟练掌握多态。');
INSERT INTO `project_item` VALUES (7, 'XX11058-007', 3, '实验5', '综合', 4, 1, '理解抽象的内涵，掌握抽象方法和抽象类的定义和使用；理解接口的内涵，掌握接口的定义和使用；掌握Java类库中基本类的使用。');
INSERT INTO `project_item` VALUES (8, 'xx123-1', 13, 'item1', '验证', 11, 1, '目的1');
INSERT INTO `project_item` VALUES (9, 'xx123-2', 13, 'item2', '综合', 21, 2, '目的2');
INSERT INTO `project_item` VALUES (15, 'xxx11-001', 18, 'item1', '综合', 2, 5, '目的1');
INSERT INTO `project_item` VALUES (16, 'xxx11-002', 18, 'item2', '验证', 2, 5, '目的2');
INSERT INTO `project_item` VALUES (17, 'xxx11-003', 18, 'item3', '验证', 2, 5, '目的2');
INSERT INTO `project_item` VALUES (21, 'xxx-101', 22, '控件', '验证', 4, 1, '控件使用');
INSERT INTO `project_item` VALUES (22, 'xxx-102', 22, '布局', '验证', 4, 1, '布局使用');
INSERT INTO `project_item` VALUES (23, 'xxx-104', 22, '网络', '验证', 4, 1, '网络使用');
INSERT INTO `project_item` VALUES (24, 'xxx-1-1', 23, '实验项目1', '验证', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (25, 'xxx-1-2', 23, '实验项目2', '综合', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (26, 'xxx-1-3', 23, '实验项目3', '验证', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (27, 'xxx-1-4', 23, '实验项目4', '综合', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (28, 'xxx-1-5', 23, '实验项目5', '验证', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (29, 'xxx-1-6', 23, '实验项目6', '综合', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (30, 'xxx-1-7', 23, '实验项目7', '验证', 4, 1, '目的1');
INSERT INTO `project_item` VALUES (31, 'xx1', 24, '实验项目名称', '验证', 1, 2, '实验目的1');
INSERT INTO `project_item` VALUES (32, 'xx2', 24, '实验项目名称', '验证', 3, 4, '实验目的2');
INSERT INTO `project_item` VALUES (33, 'xxxxx1', 25, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (34, 'xxxxx2', 25, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (35, 'xxxxx1', 26, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (36, 'xxxxx2', 26, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (37, 'xxxxx1', 27, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (38, 'xxxxx2', 27, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (39, 'xxxxx1', 28, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (40, 'xxxxx2', 28, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (41, 'xxxxx1', 29, '实验项目名称', '验证', 5, 4, '实验目的');
INSERT INTO `project_item` VALUES (42, 'xxxxx2', 29, '实验项目名称', '验证', 5, 4, '实验目的');
COMMIT;
...
INSERT INTO `teach` VALUES ('256740953460', 18210177, 0);
INSERT INTO `teach` VALUES ('344847034079', 14210669, 0);
INSERT INTO `teach` VALUES ('344847034079', 14211346, 0);
INSERT INTO `teach` VALUES ('344847034079', 14211374, 0);
INSERT INTO `teach` VALUES ('344847034079', 14211829, 0);
INSERT INTO `teach` VALUES ('344847034079', 14212048, 0);
INSERT INTO `teach` VALUES ('529144083628', 14210187, 0);
INSERT INTO `teach` VALUES ('529144083628', 14212067, 0);
INSERT INTO `teach` VALUES ('529144083628', 14212213, 0);
INSERT INTO `teach` VALUES ('529144083628', 14212214, 0);
INSERT INTO `teach` VALUES ('529144083628', 14212831, 0);
INSERT INTO `teach` VALUES ('529144083628', 14212966, 0);
INSERT INTO `teach` VALUES ('768326701984', 14213068, 0);
INSERT INTO `teach` VALUES ('768326701984', 14213072, 0);
INSERT INTO `teach` VALUES ('768326701984', 17015054, 0);
INSERT INTO `teach` VALUES ('768326701984', 17015062, 0);
INSERT INTO `teach` VALUES ('768326701984', 17015184, 0);
INSERT INTO `teach` VALUES ('768326701984', 19210322, 0);
INSERT INTO `teach` VALUES ('768326701984', 19210916, 0);
INSERT INTO `teach` VALUES ('773194542654', 14211374, 0);
INSERT INTO `teach` VALUES ('773194542654', 17015054, 0);
INSERT INTO `teach` VALUES ('773194542654', 19211634, 0);
INSERT INTO `teach` VALUES ('773194542654', 19211825, 0);
INSERT INTO `teach` VALUES ('773194542654', 19212095, 0);
INSERT INTO `teach` VALUES ('773194542654', 19212099, 0);
INSERT INTO `teach` VALUES ('773194542654', 19212413, 0);
INSERT INTO `teach` VALUES ('773194542654', 19212769, 0);
COMMIT;
