...
CREATE TABLE `arrange` (
  ...
  KEY `tid` (`tid`),
  KEY `aid` (`aid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci ROW_FORMAT=DYNAMIC COMMENT='实验时间安排';
...
INSERT INTO `arrange` VALUES (1,'B01406',1,'256740953460',17015054,'17级3、4班','无','实验','双福校区','PASS'),(3,'60201',3,'123',14211829,'计算机1班-计算机2班','无','python语言','南岸校区','AUDITING'),(4,'B01406',13,'123',14210187,'计算机3班-计算机4班','无','上机','双福校区','PASS'),(5,'60201',18,'123',14210669,'曙光班','无','汇编上机','南岸校区','PASS');
...
INSERT INTO `teach` VALUES ('123',14210187,0),('123',14210669,0),('123',14211374,0),('123',17015054,0),('123',17015184,0),('256740953460',17015054,0),('344847034079',14210669,0),('529144083628',14210187,0),('768326701984',17015184,0),('773194542654',14211374,0),('773194542654',17015054,1);
...
-- Dump completed on 2020-05-30 10:29:03
