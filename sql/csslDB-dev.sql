...
INSERT INTO `exp_project` VALUES (1,'信息技术实践教学中心','java程序设计EB','计算机',40,'计算机科学与技术','本科生',32,'《Java语言程序设计》，辛运帏，饶一梅，人民邮电出版社，2009  ','eclipse，SQL Server, jdk','256740953460','PASS','UNCHECK','java程序设计','无',2,18210177,'2019/2020(2)'),(3,'信息技术实践教学中心','python语言','计算机',40,'计算机科学与技术','本科生',45,'《数据预处理》','python','123','PASS','UNCHECK','python','无',2,14211829,'2019/2020(2)'),(13,'信息技术实践教学中心','上机','设备',1,'计算机科学与技术','本科生',40,'教材','软件','123','PASS','AUDITING','操作系统原理A','材料',1,14210187,'2019/2020(2)'),(18,'信息技术实践教学中心','汇编上机','计算机',50,'计算机科学与技术','本科生',30,'教材','软件','123','PASS','UNCHECK','汇编与计算机组成原理','材料',10,14210669,'2019/2020(2)'),(22,'信息技术实践教学中心','移动app开发','计算机',40,'计算机科学与技术','本科生',30,'教材无','android studio','123','PASS','AUDITING','移动互联APP','无',0,14211374,'2019/2020(2)'),(23,'信息技术实践教学中心','上机实验','计算机',40,'计算机科学与技术','本科生',24,'教材1','vs','123','PASS','AUDITING','高级语言程序设计','无',0,17015054,'2019/2020(2)'),(24,'信息技术实践教学中心','大数据概论实验','计算机',40,'计算机科学与技术','本科生',40,'实验教材','实验所用软件','123','PASS','AUDITING','大数据概论','无',0,17015184,'2019/2020(1)'),(25,'信息技术实践教学中心','实验课程名','计算机',0,'计算机科学与技术','本科生',40,'实验教材','实验所用软件','344847034079','PASS','AUDITING','汇编与计算机组成原理','无',0,14210669,'2019/2020(2)'),(26,'信息技术实践教学中心','实验课程名','计算机',0,'计算机科学与技术','本科生',40,'实验教材','实验所用软件','344847034079','PASS','AUDITING','信息论与编码B','无',0,14211346,'2019/2020(2)'),(27,'信息技术实践教学中心','实验课程名','计算机',0,'计算机科学与技术','本科生',40,'实验教材','实验所用软件','344847034079','PASS','AUDITING','移动互联APP','无',0,14211374,'2019/2020(2)'),(28,'信息技术实践教学中心','实验课程名','计算机',0,'计算机科学与技术','本科生',40,'实验教材','实验所用软件','344847034079','PASS','AUDITING','程序设计方法学','无',0,14211829,'2019/2020(2)'),(29,'信息技术实践教学中心','实验课程名','计算机',0,'计算机科学与技术','本科生',40,'实验教材','实验所用软件','344847034079','PASS','AUDITING','电子技术课外实践','无',0,14212048,'2019/2020(2)');
...
INSERT INTO `project_item` VALUES (1,'XX11058-001',1,'实验1','验证',2,1,'熟悉JDK的安装和配置；熟悉Java IDE开发环境的安装；学习利用JDK和IDE开发工具编写简单的Java程序，熟悉Java程序的编写、编译和运行过程。'),(2,'XX11058-002',1,'实验2','验证',2,1,'理解面向过程和面向对象；学会查阅JDK API文档；在类的方法中熟练使用三种基本控制结构'),(3,'XX11058-003',1,'实验3','验证',2,1,'熟悉Java数组的定义、初始化和使用；掌握类的定义、创建对象；掌握方法的定义、重载；理解成员变量和局部变量。'),(4,'XX11058-004',1,'实验4','验证',4,1,'熟练掌握构造器的定义和重载；熟练掌握类的继承；熟练使用访问控制符实现所需的封装要求；熟练掌握多态。'),(5,'XX11058-005',1,'实验5','综合',4,1,'理解抽象的内涵，掌握抽象方法和抽象类的定义和使用；理解接口的内涵，掌握接口的定义和使用；掌握Java类库中基本类的使用。'),(6,'XX11058-006',3,'实验4','验证',4,1,'熟练掌握构造器的定义和重载；熟练掌握类的继承；熟练使用访问控制符实现所需的封装要求；熟练掌握多态。'),(7,'XX11058-007',3,'实验5','综合',4,1,'理解抽象的内涵，掌握抽象方法和抽象类的定义和使用；理解接口的内涵，掌握接口的定义和使用；掌握Java类库中基本类的使用。'),(8,'xx123-1',13,'item1','验证',11,1,'目的1'),(9,'xx123-2',13,'item2','综合',21,2,'目的2'),(15,'xxx11-001',18,'item1','综合',2,5,'目的1'),(16,'xxx11-002',18,'item2','验证',2,5,'目的2'),(17,'xxx11-003',18,'item3','验证',2,5,'目的2'),(21,'xxx-101',22,'控件','验证',4,1,'控件使用'),(22,'xxx-102',22,'布局','验证',4,1,'布局使用'),(23,'xxx-104',22,'网络','验证',4,1,'网络使用'),(24,'xxx-1-1',23,'实验项目1','验证',4,1,'目的1'),(25,'xxx-1-2',23,'实验项目2','综合',4,1,'目的1'),(26,'xxx-1-3',23,'实验项目3','验证',4,1,'目的1'),(27,'xxx-1-4',23,'实验项目4','综合',4,1,'目的1'),(28,'xxx-1-5',23,'实验项目5','验证',4,1,'目的1'),(29,'xxx-1-6',23,'实验项目6','综合',4,1,'目的1'),(30,'xxx-1-7',23,'实验项目7','验证',4,1,'目的1'),(31,'xx1',24,'实验项目名称','验证',4,5,'实验目的'),(32,'xx2',24,'实验项目名称','验证',4,5,'实验目的'),(33,'xxxxx1',25,'实验项目名称','验证',5,4,'实验目的'),(34,'xxxxx2',25,'实验项目名称','验证',5,4,'实验目的'),(35,'xxxxx1',26,'实验项目名称','验证',5,4,'实验目的'),(36,'xxxxx2',26,'实验项目名称','验证',5,4,'实验目的'),(37,'xxxxx1',27,'实验项目名称','验证',5,4,'实验目的'),(38,'xxxxx2',27,'实验项目名称','验证',5,4,'实验目的'),(39,'xxxxx1',28,'实验项目名称','验证',5,4,'实验目的'),(40,'xxxxx2',28,'实验项目名称','验证',5,4,'实验目的'),(41,'xxxxx1',29,'实验项目名称','验证',5,4,'实验目的'),(42,'xxxxx2',29,'实验项目名称','验证',5,4,'实验目的');
...
-- Dump completed on 2020-05-31 15:36:19
